...
/*
|--------------------------------------------------------------------------
| REDIRECT SETELAH LOGIN (TANPA PILIH SISTEM)
|--------------------------------------------------------------------------
*/
...
Route::middleware(['auth','cekrole:admin,karyawan'])->group(function () {
    ...
    Route::get('data-karyawan/{data_karyawan}/download-qr', [KaryawanController::class,'downloadQr'])->name('data-karyawan.downloadQr');
});
...
Route::middleware(['auth','cekrole:admin,karyawan'])->group(function () {
    ...
    Route::get('kritik_saran', [KritikSaranController::class, 'index'])->name('kritik_saran.index');
    Route::get('kritik_saran/create', [KritikSaranController::class, 'create'])->name('kritik_saran.create');
    Route::post('kritik_saran', [KritikSaranController::class, 'store'])->name('kritik_saran.store');
    Route::delete('kritik_saran/{id}', [KritikSaranController::class, 'destroy'])->name('kritik_saran.destroy');
    Route::post('kritik_saran/{id}/komentar', [KritikSaranController::class,'komentar'])->name('kritik_saran.komentar');
});